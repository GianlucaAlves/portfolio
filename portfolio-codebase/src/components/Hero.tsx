...
export default function Hero({ lang }: HeroProps) {
  ...
  return (
    <div className="flex flex-col pt-12 sm:pt-16 items-center justify-center min-h-screen max-h-screen overflow-y-auto bg-black px-2 sm:px-4 w-full">
      ...
      <h1 className="text-green-400 font-mono text-xl sm:text-3xl md:text-5xl font-bold mb-1 text-center break-words max-w-full">
        {texts.name}
      </h1>
      <p className="text-green-300 font-mono text-base sm:text-xl mb-2 text-center break-words max-w-full">
        {texts.title}
      </p>
